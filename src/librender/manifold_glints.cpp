...
MTS_VARIANT std::atomic<int> SpecularManifoldGlints<Float, Spectrum>::stats_mfw_failed(0);
MTS_VARIANT std::atomic<int> SpecularManifoldGlints<Float, Spectrum>::stats_mfw_succeeded(0);
...
MTS_IMPLEMENT_CLASS_VARIANT(SpecularManifoldGlints, Object, "manifold_ms")
